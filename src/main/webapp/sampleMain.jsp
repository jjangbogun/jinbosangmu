...
<jsp:include page="./include/incTop.jsp"></jsp:include>
        ...
        <section id="intro" class="dark-bg">
            ...
            <div class="owl-carousel fullwidth-slider white o-flow-hidden">
                <!--Slide-->
                <div class="item bg-img slide-bg-image parallax parallax-section1" data-background-img="images/intro-bg1.jpg">
                    <!-- Content -->
                    <div class="full-cap-wraper overlay-dark40 light-color">
                        <div class="content-caption light-color">
                            <div class="container">
                    			<p class="lead">롯데호텔 서울</p>
                                <h2>국내 최고의 럭셔리 비즈니스 호텔인 롯데호텔 서울은 1,015실 규모를 자랑하며<br>서울 소공동에 자리잡고 있습니다.</h2>
                                <br />
                ...
                <!--Slide-->
                <div class="item bg-img slide-bg-image parallax parallax-section1" data-background-img="images/intro-bg2.jpg">
                    <!-- Content -->
                    <div class="full-cap-wraper overlay-dark40 light-color">
                        <div class="content-caption light-color">
                            <div class="container">
                    <p class="lead">시그니엘 부산</p>
                                        <h2>시그니엘 부산은 해운대의 랜드마크 '엘시티(LCT)' 타워에 위치한<br> 260실 규모의 럭셔리 호텔입니다.</h2>
                                        <br />
                                        <div class="xs-hidden"><a class="btn btn-outline-light" onclick="main_content();">자세히보기</a></div>
                            </div>
                        </div>
                ...
                <!--Slide-->
                <div class="item bg-img slide-bg-image parallax parallax-section1" data-background-img="images/intro-bg3.jpg">
                    <!-- Content -->
                    <div class="full-cap-wraper overlay-dark40 light-color">
                        <div class="content-caption light-color">
                            <div class="container">
                    			<p class="lead">L7 강남</p>
                                        <h2>패션쇼 런웨이처럼 화려한 유행의 거리 강남. 이 감각적인 도시의 문화를 닮은 L7 강남은<br> 서울 강남의 중심에 위치한 라이프 스타일 호텔입니다.</h2>
                                        <br />
                                        <div class="xs-hidden"><a class="btn btn-outline-light" onclick="main_content();">자세히보기</a></div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        ...
                        <h4 class="text-s-white">롯데호텔 리워즈 회원 가입하고, 선물 받아 가세요!</h4>
                    </div>
