...
@WebServlet(value = "/admin/hotel/list")
...
//            미리 준비된 DB 객체 불러오기
			...
			int pageNum = 1;
			int pageSize = 10;
			int total = hotelDao.getTotal(searchField, searchText); // 전체게시글수
			...
			ArrayList<HotelDto> hotelList = (ArrayList<HotelDto>) hotelDao.hotelList(pageNum, pageSize,
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/admin/hotel/HotelList.jsp");
